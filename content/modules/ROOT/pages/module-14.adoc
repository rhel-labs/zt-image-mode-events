...
There's quite a bit of size difference between these images, but we may be missing certain expected functionality.
...
localhost/httpd  direct      79cdd520320e  About a minute ago  706 MB
localhost/httpd  min         4de92f83914d  23 minutes ago      767 MB
localhost/httpd  base        88efe5cd0566  3 hours ago         1.71 GB
....
