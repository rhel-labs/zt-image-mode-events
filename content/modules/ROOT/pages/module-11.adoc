...
First up, update the FROM line to reference the baseline image you've been building and updating during this lab. 
...
Since we had issues with switching in our initial troubleshooting, log into the _Security VM SSH session_ to test the new build.
