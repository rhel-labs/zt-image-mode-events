...
Having a serial console makes the next test more intersting, and luckily we can get one to our virtual machine.
...
If you like you can execute the next `bootc` instruction in this serical session instead of the web terminal.
...
So far, the reboots of our VMs have been fairly quick, but you can scroll through the ouput to see that this reboot is different.
